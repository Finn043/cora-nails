...
const Footer = () => {
  return (
    <footer className="py-10 md:py-12" style={{ backgroundColor: '#FCDAC2' }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8 mb-6 md:mb-8">
          {/* Logo/Brand */}
          <div>
            <h2 className="text-xl md:text-2xl font-light tracking-widest mb-3 md:mb-4 text-charcoal">STUDIO.APRIL</h2>
          </div>
