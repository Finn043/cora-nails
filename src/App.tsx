...
const serviceGroups = [
  ...
  { title: 'Manicure', items: [
    { name: 'Classic Manicure', price: '$35', note: 'Nail and cuticle care, massage, moisturiser and polish. Colour removal included.' },
    { name: 'Cora Deluxe Manicure', price: '$65', time: '60 min', note: 'Nail and cuticle care, premium scrub, hydrating mask, warm towel, massage, premium moisturiser and shellac. Colour removal included.' },
    { name: 'Gel Manicure', price: '$55', time: '45 min', note: 'Detailed prep, cuticle care, gel colour, massage and moisturiser. Colour removal included.' },
    { name: 'Shellac', price: '$45', time: '30 min', note: 'Cut, shape and polish. Colour removal included.' },
  ]},
  { title: 'Pedicure', items: [
    { name: 'Classic Pedicure', price: '$55', time: '40 min', note: 'Soak, nail and cuticle care, heel and callus care, scrub, warm towels, steam therapy, massage, moisturiser and classic polish. Colour removal included.' },
    { name: 'Cora Deluxe Pedicure', price: '$85', time: 'From 60 min', note: 'Soak, nail and cuticle care, heel and callus care, premium scrub, hydrating mask, steam therapy, warm towels, candle massage, premium moisturiser and shellac. Colour removal included.' },
    { name: 'Gel Pedicure', price: '$65', time: '45 min', note: 'Soak, nail and cuticle care, heel and callus care, scrub, warm towel, steam therapy, massage, moisturiser and gel colour. Colour removal included.' },
    { name: 'Shellac', price: '$40', time: '20 min', note: 'Cut, shape and polish. Colour removal included.' },
  ]},
  { title: 'Cora Duos', items: [
    ...
    { name: 'Cora Deluxe · Mani + Pedi', price: '$140', time: '100 min', note: 'Cora Deluxe Manicure and Cora Deluxe Pedicure.' },
    { name: 'Cora Builder Pedicure', price: '$135', time: '90 min', note: 'Shellac pedicure and builder overlay.' },
  ]},
  { title: 'Design & Removal', items: [
    { name: 'French', price: 'From $20', note: 'A timeless French finish.' },
    { name: 'Ombré', price: 'From $25', note: 'A soft blended colour finish.' },
    ...
    { name: 'Removal', price: '$30', time: '25 min', note: 'Safe removal of existing product.' },
  ]},
]
